...
public class Benchmarks extends JFrame {
	...
	/**
	 * Fills a[] with random numbers and sorts it using the sorting method specified
	 * in sortMethod: 1 -- Selection Sort 2 -- Insertion Sort 3 -- Mergesort 4 --
	 * Quicksort This is repeated numberOfRuns times for better accuracy Returns the
	 * total time it took in milliseconds.
	 */
